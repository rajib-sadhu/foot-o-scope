...
const createBlogs = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const addBlog = yield database_1.pool.query("INSERT INTO tbl_blog (blog_title,blog_desc,blog_image_file_name,blog_tag_name) VALUES ($1,$2,$3,$4)", [blogTitle, blogDesc, blogImageName, blogTagName]);
